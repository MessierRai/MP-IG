...
class sfBanco(QWidget):
	...
	def acessoContas(self):
		numAcessoConta, ok = QInputDialog.getText(self, 'Acessar Conta', 'Digite o número da conta:')
	...
	def deposito(self):
		...
		if ok:
			try :
				...
				self.contas[self.conta.numero] = self.conta.saldo
